...
function App() {
    ...
    const [centerBlur, setCenterBlur] = useState(0)
    const [sideBlur, setSideBlur] = useState(2)
    const [outSideBlur, setOutSideBlur] = useState(4)
        ...
        <div className="grid grid-cols-5 h-screen">
            <div className='col-span-1 bg-red-50 p-4'>
                <div className='space-y-4'>
                    ...
                    <div className='flex items-center'>
                        <label className='w-1/3'>Center Blur: </label>
                        <input
                            className='w-2/3 p-2 border rounded'
                            value={centerBlur}
                            onChange={(e) => setCenterBlur(e.target.value)}
                        />
                    </div>
                    <div className='flex items-center'>
                        <label className='w-1/3'>Side Blur: </label>
                        <input
                            className='w-2/3 p-2 border rounded'
                            value={sideBlur}
                            onChange={(e) => setSideBlur(e.target.value)}
                        />
                    </div>
                    <div className='flex items-center'>
                        <label className='w-1/3'>Outside Blur: </label>
                        <input
                            className='w-2/3 p-2 border rounded'
                            value={outSideBlur}
                            onChange={(e) => setOutSideBlur(e.target.value)}
                        />
                    </div>
                    <div className='flex items-center'>
            ...
            <div className='col-span-4 flex flex-col items-center justify-center'>
                ...
                <ImageSlider
                    ...
                    sideScale={5}
                    outerScale={0.6}
                    centerBlur={centerBlur}
                    sideBlur={sideBlur}
                    outerBlur={outSideBlur}
